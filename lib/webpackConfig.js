...
async function chainWebpack (api, pluginOptions, config) {
  ...
  if (process.env.NODE_ENV === 'test') {
    ...
    config.externals({
      '@matthijsburgh/vue-cli-plugin-electron-builder/lib/testWithSpectron':
        'require("@matthijsburgh/vue-cli-plugin-electron-builder/lib/testWithSpectron")',
      '@matthijsburgh/vue-cli-plugin-electron-builder/lib/testWithPlaywright':
        'require("@matthijsburgh/vue-cli-plugin-electron-builder/lib/testWithPlaywright")',
      '@matthijsburgh/vue-cli-plugin-electron-builder':
        'require("@matthijsburgh/vue-cli-plugin-electron-builder")'
    })
  }
